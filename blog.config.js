...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'MPL', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享实用技术资源、工具评测与学习心得', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://top.zones.im', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术资源导航,编程教程,开发工具推荐,开源项目分享 zones,zones.im', // 网站关键词 英文逗号隔开
